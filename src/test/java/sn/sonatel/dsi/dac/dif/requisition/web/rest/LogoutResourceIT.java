...
import static sn.sonatel.dsi.dac.dif.requisition.web.rest.TestUtil.ID_TOKEN;
import static sn.sonatel.dsi.dac.dif.requisition.web.rest.TestUtil.authenticationToken;
...
import sn.sonatel.dsi.dac.dif.requisition.RequisitionApp;
import sn.sonatel.dsi.dac.dif.requisition.config.TestSecurityConfiguration;

/**
 * Integration tests for the {@link LogoutResource} REST controller.
 */
@SpringBootTest(classes = { RequisitionApp.class, TestSecurityConfiguration.class })
